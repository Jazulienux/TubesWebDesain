<?php
    ...
    $account = viewAccount("SELECT * FROM login");
    ...
    if(isset($_POST["addAccount"])){
        header('Location:../formulir/formulir_login.php');
        exit;
    }
            ...
            <table class="table table-hover" border="3">
                <thead>
                    <tr>
                        ...
                        <th  style="background-color: #8FBC8F;">Username</th>
                        <th  style="background-color: #8FBC8F;">Password</th>
                        <th  style="background-color: #8FBC8F;">Type User</th>
                ...
                <?php foreach($account as $row):?>
                    <tr>
                        ...
                        <td class="btn-light"><?=$row["username"]; ?></td>
                        <td class="btn-light"><?=$row["password"]; ?></td>
                        <td class="btn-light"><?=$row["typeuser"]; ?></td>
                        <td class="btn-light">
                        <div class="form-group">
                            <div class="row col-sm-7">    
                                    <div class="col">
                                        <a href="../proses/update-delete/aksi_loginUpdate.php?id=<?php echo $row["id"];?>">
                                        <img src="../../logo/update.png" width="40px"><br>Update</a>
                                    </div>
                                    <div class="col">
                                    <a href="../proses/update-delete/aksi_loginHapus.php?id=<?php echo $row["id"];?>" onclick="return confirm('Apakah Data Account Ingin Dihapus')">
