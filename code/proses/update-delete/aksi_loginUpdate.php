...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <?php
        ...
        //query berdasar id
        $mhs = viewAccount("SELECT * FROM login WHERE id=$id")[0];
        // var_dump($mhs);
        //  var_dump($mhs[0]["Nama"]);
    ?>
     <form class="form-horizontal" method="POST" role="form" enctype="multipart/form-data">
            ...
            <div class="transparent">
                ...
                <center><b><label for="">Edit Akun TiOn</b></label></center>
                <br/>
                <div class="form-group">
                    <div class="row col-sm-12">    
                        <label for="" class="col-sm-12 control-label">Username</label>
                            <div class="col">
                                <input type="text" class="form-control" placeholder="Username" name="username" value="<?= $mhs["username"]; ?>"required>
                            </div>
                    </div>
                </div>
                <div class="form-group">
                    <div class="row col-sm-12">    
                        <label for="" class="col-sm-12 control-label">Password</label>
                            <div class="col">
                                <input type="password" class="form-control" placeholder="Password" name="password" value="<?= $mhs["password"]; ?>" required>
                            </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="row col-sm-12">    
                        <label for="" class="col-sm-12 control-label">Password Konfirmasi</label>
                            <div class="col">
                                <input type="password" class="form-control" placeholder="Password" name="password_konf" value="<?= $mhs["password"]; ?>" required>
                            </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="row col-sm-12">    
                        <label for="" class="col-sm-12 control-label">Nomor Polisi</label>
                            <div class="col">
                                <input type="text" class="form-control" placeholder="Nomor Polisi" name="nopol" value="<?= $mhs["nopol"]; ?>">
                            </div>
                    </div>
                </div>
                <div class="form-group">
                    <div class="row col-sm-12">    
                        <label for="" class="col-sm-12 control-label">Kode Polisi</label>
                            <div class="col">
                                <input type="text" class="form-control" placeholder="Kode Polisi" name="kodepolisi" value="<?= $mhs["kodepolisi"]; ?>">
                            </div>
                    </div>
                </div>
